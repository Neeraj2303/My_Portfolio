    ...
    return (
        <div className="glass-theme">
            ...
            <div className="glass-container">
                ...
                <header className="glass-card glass-hero">
                    <h1>{personal.name}</h1>
                    <p>{personal.role}</p>
                ...
                <section className="glass-card" style={{ background: 'transparent', boxShadow: 'none', border: 'none', padding: '0' }}>
                    ...
                    <div className="glass-grid">
                        {projects.map((project) => (
                            <a href={project.link} key={project.id} className="glass-project-card">
                                <h3>{project.name}</h3>
                ...
                <footer className="glass-card" style={{ textAlign: 'center', padding: '4rem' }}>
